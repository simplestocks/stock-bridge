        ...
        function showLoading() {
            contentArea.innerHTML = `
                <div class="loading">
                    ...
                    <br><br>
                    This includes: Company Overview, Balance Sheet, Cash Flow, and Technical Analysis
                </div>
            `;
        }
        ...
        function displayStockData(ticker, data) {
            ...
            contentArea.innerHTML = `
                ...
                <div class="card price-section">
                    <div class="price">Real-time data requires premium Alpha Vantage</div>
                    <div class="price-change neutral">See analysis below for fundamentals</div>
                    <div class="price-details">
                        <div class="price-item">
                            <div class="price-label">TICKER</div>
                            <div class="price-value">${ticker}</div>
                        </div>
                        <div class="price-item">
                            <div class="price-label">DATA SOURCE</div>
                            <div class="price-value">Alpha Vantage</div>
                        </div>
                        <div class="price-item">
                            <div class="price-label">ANALYSIS</div>
                            <div class="price-value">Fundamental</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card technical-section">
                    ...
                    <div class="alert-box">
                        ⚠️ Technical data requires premium Alpha Vantage plan
                    </div>
                    
                    <div class="data-row">
                        <div class="data-label">Data Available</div>
                        <div class="data-value">Fundamental Only</div>
                    </div>
                </div>
